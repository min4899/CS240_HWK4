/**
   ...
   @author Minwoo Soh
*/
public final class LinkedPriorityQueue<T extends Comparable<T>> implements PriorityQueueInterface<T>
{
  ...
  public void add(T newEntry)
  {
    ...
    {
      // The greater value has the higher priority.
      if(newNode.compareTo(firstNode) > 0) // If entry is greater than firstNode.
      {
        newNode.next = firstNode;
        firstNode = newNode;
        numberOfEntries++;
      }
      else if(newNode.compareTo(lastNode) <= 0) // If entry is lower than or equal to lastNode.
      {
